...
export default function LocationPage() {
  ...
  const mapEmbedUrl = "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3478.1451777139478!2d79.5683483!3d29.3367408!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39a0972a3c3ef22b%3A0xd034cc7aef752fe5!2sSilver%20Steps%20Villa!5e0!3m2!1sen!2sin!4v1781078225157!5m2!1sen!2sin"; 
  const directionsUrl = "https://maps.app.goo.gl/shmtrcDsghzvmNiH7";

  return (
    <main className="min-h-screen py-24 bg-[#F4F1EA]">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          <div className="space-y-10">
            ...
            <div className="flex gap-4">
              ...
              <div>
                <h4 className="text-lg font-bold text-[#2D3A3A]">Villa Address</h4>
                <p className="text-[#2D3A3A]/70 mt-1">Dungsil Talla, Near Bhimtal Lake, Uttarakhand, India - 263136</p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div className="p-6 bg-white rounded-2xl border border-[#2D3A3A]/10 shadow-sm">
                ...
                <p className="text-xs text-[#2D3A3A]/50 mt-1 font-medium">~2 hrs by Taxi</p>
              </div>
              ...
              <div className="p-6 bg-white rounded-2xl border border-[#2D3A3A]/10 shadow-sm">
                ...
                <p className="text-xs text-[#2D3A3A]/50 mt-1 font-medium">~45 mins by Taxi</p>
              </div>
              ...
              <div className="p-6 bg-white rounded-2xl border border-[#2D3A3A]/10 shadow-sm sm:col-span-2">
                ...
                <p className="text-sm text-[#2D3A3A]/70">Well-connected via NH109. Direct access to the villa gate with private parking.</p>
              </div>
            </div>
            ...
            <a 
              ...
              className="inline-flex items-center gap-3 bg-[#2D3A3A] text-white px-8 py-4 rounded-full font-bold hover:bg-[#C5A059] transition-all shadow-lg"
            >
              <Navigation size={20} />
              GET DIRECTIONS
            </a>
