...
export default function GalleryPage() {
  return (
    <section className="py-0 overflow-hidden">
      {/* Grid Setup:
        - Mobile: 2 columns, rows are 200px
        - Desktop: 4 columns, rows are 300px
      */}
        ...
        {GALLERY_IMAGES.map((src, i) => (
          <div 
            ...
            className={`relative overflow-hidden ${
              // Logic: 
              // Mobile par har 3rd element ko bada karo (col-span-2)
              // Desktop par har 5th element ko bada karo (col-span-2, row-span-2)
              i % 3 === 0 
                ? "col-span-2" 
                : "col-span-1" 
            } ${
